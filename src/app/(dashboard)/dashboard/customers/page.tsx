...
Nội dung CK: ${memo}`;
            ...
            return (
              <div className="flex flex-col flex-1 min-h-0 gap-2 pt-2">
                  ...
                  <div style={{ backgroundColor: '#f8fafc', width: '100%', borderRadius: '10px', border: '1px solid #e2e8f0', overflow: 'hidden' }}>
                    <div style={{ padding: '10px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <span style={{ color: '#1e293b', fontSize: '11px', fontWeight: 'bold', textTransform: 'uppercase' }}>{bankId}</span>
                      </div>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <span style={{ color: '#64748b', fontSize: '11px' }}>Số tài khoản:</span>
                        <span style={{ color: '#1e293b', fontSize: '11px', fontWeight: 'bold' }}>{accountNo}</span>
                      </div>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        <span style={{ color: '#64748b', fontSize: '11px' }}>Chủ tài khoản:</span>
                        <span style={{ color: '#1e293b', fontSize: '10px', fontWeight: 'bold', textTransform: 'uppercase', textAlign: 'right', lineHeight: '1.2', maxWidth: '65%' }}>{accountName}</span>
                      </div>
                      <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: '6px', marginTop: '2px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <span style={{ color: '#2563eb', fontSize: '16px', fontWeight: 'bold' }}>{formatCurrency(amount)}</span>
                      </div>
                ...
                <Button variant="ghost" onClick={() => setQrModalOpen(false)} className="w-full h-8 text-xs mt-2 shrink-0">Đóng</Button>
              </div>
            );
          })()}
        </DialogContent>
